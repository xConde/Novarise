...
const TUTORIAL_TIPS: Record<TutorialStep, TutorialTip> = {
  [TutorialStep.WELCOME]: {
    ...
    message: 'Defend your base using cards. Each combat encounter is a series of turns — play cards, then end your turn to let combat resolve automatically.',
    position: 'center',
  },
  [TutorialStep.SELECT_TOWER]: {
  ...
  [TutorialStep.PLACE_TOWER]: {
    ...
    type: 'tutorial',
    title: 'Play a Tower Card',
    message: 'Click a tower card to select it — valid placements light up on the board. Click a highlighted tile to place the tower. Spells and modifiers take effect immediately.',
    position: 'center',
  },
  [TutorialStep.START_WAVE]: {
    ...
    message: 'The wave preview (between waves) and Incoming panel (during combat) show you which enemies arrive and when. Use this to decide which cards to play.',
  ...
  [TutorialStep.COMPLETE]: {
    ...
    type: 'tutorial',
    title: 'You\'re Ready!',
    message: 'That\'s the loop. Play cards, read the board, end your turn. Press P anytime to pause, review your relics, or save and exit.',
    position: 'center',
  },
  [TutorialStep.TIP_PLACEMENT]: {
    ...
    message: 'Towers near bends and chokepoints get more attacks per enemy — enemies spend longer in range. A well-placed tower outperforms a poorly-placed upgrade.',
    position: 'center',
  },
  [TutorialStep.TIP_WAVE_PREVIEW]: {
    ...
    type: 'tip',
    title: 'Manage your three piles',
    message: 'Your deck cycles through draw, discard, and exhaust. Click any pile counter to inspect it. Exhausted cards are gone until end of combat — use them wisely.',
    targetSelector: '.card-hand__piles',
    position: 'top',
  },
  [TutorialStep.TIP_UPGRADE]: {
    ...
    type: 'tip',
    title: 'Lean into your deck\'s archetype',
    message: 'Rest sites let you upgrade cards. Your reward pool tilts toward your dominant archetype (Cartographer, Highground, or Conduit) — commit early for stronger synergies.',
    position: 'center',
  },
};
