/**
 * Ascent Mode — Integration Flow Tests
 *
 ...
 * Mocked: MapBridgeService, CampaignMapService, PlayerProfileService
...
import { REWARD_CONFIG, REST_CONFIG, NODE_MAP_CONFIG } from '../constants/ascent.constants';
...
const STUB_MAP_STATE: TerrainGridState = {
  gridSize: 10,
...
describe('Ascent Mode — Integration Flow', () => {
  ...
  beforeEach(() => {
    ...
    playerProfile = jasmine.createSpyObj('PlayerProfileService', ['recordAscentRun']);

    campaignMapService.loadLevel.and.returnValue(STUB_MAP_STATE);
  ...
  it('should set VICTORY status after act 2 boss defeat', fakeAsync(() => {
    ...
    expect(playerProfile.recordAscentRun).toHaveBeenCalled();
  }));
