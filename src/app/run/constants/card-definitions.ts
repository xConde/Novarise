...
import { CARD_VALUES } from './card-values.constants';
...
export const CARD_DEFINITIONS: Record<CardId, CardDefinition> = {
  ...
  [CardId.TOWER_BASIC_REINFORCED]: {
    ...
    flavorText: 'Extra plating costs extra. The invoice is justified.',
    type: CardType.TOWER,
  ...
  [CardId.TOWER_SPLASH_CLUSTER]: {
    ...
    flavorText: 'Tighter detonation radius. More hits per blast, less margin.',
    type: CardType.TOWER,
    rarity: CardRarity.COMMON,
  ...
  [CardId.TOWER_CHAIN_TESLA]: {
    ...
    flavorText: 'More arcs, more contacts, more debt for the enemy to pay.',
    type: CardType.TOWER,
    rarity: CardRarity.COMMON,
