...
export const TOWER_UPGRADE_VISUAL_CONFIG = {
   ...
   * UX-9: opacity dropped 0.8 → 0.65, color tinted toward warm gold
   * (0xffeacc) instead of pure white. Pure-white flash at 0.8 opacity
   * was visually loud against the now-darker board — felt more like a
   * UI alert than an integrated game effect.
   */
  flash: {
    color: 0xffeacc,
    opacity: 0.65,
   ...
   * UX-9: opacity dropped 0.4 → 0.35, segments smoothed 32 → 64.
   * Purple base color (0x8a5cf6) reads well against the cool dark
   * palette — kept.
   */
  glowRing: {
    innerRadius: 0.3,
