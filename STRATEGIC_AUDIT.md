...
- [ ] Step 4: Place MINER in at least one standard wave so the enemy actually appears in real play-through. Balance TBD, but a zero-ship enemy isn't stood up.
- [ ] Step 5: Devil's-advocate review of Phase 2 as a whole — what would have made this phase stronger? What's the next-most-likely thing to break in Phase 3 (Highground) that we should pre-defend now?
- [ ] Step 6: Update `MEMORY.md` with Phase 2 close — list shipped cards/relics/enemies/services, deferred items (wave placement for UNSHAKEABLE/VEINSEEKER, numeric balance tuning, shader/shimmer polish), and Phase 3 prep notes.
